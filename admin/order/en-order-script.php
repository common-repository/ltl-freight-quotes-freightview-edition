...
namespace EnFreightviewOrderScript;

/**
 * Script for send ajax request.
 * Class EnFreightviewOrderScript
 * @package EnFreightviewOrderScript
 */
if (!class_exists('EnFreightviewOrderScript')) {
    ...
    class EnFreightviewOrderScript
    {
         ...
         * EnFreightviewOrderScript constructor.
         */
        public function __construct()
        {
            add_action('admin_print_scripts', [$this, 'en_freightview_order_script'], 50);
        }

        public function en_freightview_order_script()
        {
            global $post;
            ?>
                    ...
                    let data =
                        {
                            ...
                            'action': 'en_freightview_admin_order_quotes'
                        };
                    jQuery.ajax({
                        type: "POST",
                        url: ajaxurl,
