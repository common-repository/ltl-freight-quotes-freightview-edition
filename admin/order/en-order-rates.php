...
namespace EnFreightviewOrderRates;

/**
 * Order page rates.
 * Class EnFreightviewOrderRates
 * @package EnFreightviewOrderRates
 */
if (!class_exists('EnFreightviewOrderRates')) {
    ...
    class EnFreightviewOrderRates
    {
         ...
         * EnFreightviewOrderRates constructor.
         */
        public function __construct()
        {
            add_action('wp_ajax_nopriv_en_freightview_admin_order_quotes', array($this, 'en_freightview_admin_order_quotes'));
            add_action('wp_ajax_en_freightview_admin_order_quotes', array($this, 'en_freightview_admin_order_quotes'));
        }

        /**
         * Get quotes from calculate shipping forcefully
         */
        public function en_freightview_admin_order_quotes()
        {
            global $woocommerce;
            $errors = array();
            ...
            $shipping_class = new \EnFreightviewShippingRates();
