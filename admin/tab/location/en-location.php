        ...
        static public function en_location_data() {
            ...
            $en_location_data = [
                ...
                'zip' => [
                    ...
                    'name' => 'zip',
                    'placeholder' => '30214',
                    'id' => 'en_freightview_location_zip',
                    'label' => 'Zip',
                    'class' => 'en_location_input_field',
                    'append' => ' maxlength="7" ',
                    'frontend' => 'show',
...
//      We can use hook for add new location field from other plugin add-on
            return apply_filters('en_freightview_add_location', $en_location_data);
        }
        ...
        static public function en_arrange_location_table_row($en_location_list, $en_data, $location_bol, $disabled_plan = '') {
            ...
            foreach ($en_location_list as $key => $location) {
                ...
                echo '<a href="javascript(0)" onclick="return en_freightview_location_edit(event, this,' . $location_bol . ')"> <img src = "' . EN_FREIGHTVIEW_DIR_FILE . '/admin/tab/location/assets/images/edit.png" title = "Edit" ></a>';
                echo '<a href="javascript(0)" onclick="return en_freightview_location_delete(event, this,' . $location_bol . ' , ' . esc_attr($en_location_id) . ')"> <img  src = "' . EN_FREIGHTVIEW_DIR_FILE . '/admin/tab/location/assets/images/delete.png" title = "Delete" ></a>';
                echo '</td>';
        ...
        static public function en_load() {
            ...
            echo '<input type="submit" value="Save" class="en_freightview_location_btn button-primary">';
            echo '</form>';
            echo '</div>';
            echo '</div>';

            echo \EnFreightviewWarehouseTemplate\EnFreightviewWarehouseTemplate::en_load();
            echo \EnFreightviewDropshipTemplate\EnFreightviewDropshipTemplate::en_load();
        }
