...
namespace EnFreightviewDropshipTemplate;

use EnFreightviewWarehouse\EnFreightviewWarehouse;

if (!class_exists('EnFreightviewDropshipTemplate')) {

    class EnFreightviewDropshipTemplate
    {
        ...
        {
            $en_heading = $en_data = [];
            $en_dropship_list = EnFreightviewWarehouse::get_data(['location' => 'dropship']);
