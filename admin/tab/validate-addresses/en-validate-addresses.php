...
namespace EnFreightviewValidateaddress;

/**
 * User guide add detail.
 * Class EnFreightviewValidateaddress
 * @package EnFreightviewValidateaddress
 */
if (!class_exists('EnFreightviewValidateaddress')) {
