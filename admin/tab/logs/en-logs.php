    ...
    class EnFVLfqLogs
    {
        ...
        public function enLogs()
        {
            $data = array(
                ...
                'lastLogs' => '25',
                'carrierName' => EN_FREIGHTVIEW_SHIPPING_NAME,
            );

            require_once 'en-json-tree-view/en-jtv.php';

            $url = FREIGHTVIEW_DOMAIN_HITTING_URL . '/request-log/index.php';
            $obj_classs = new EnFreightviewCurl();
            $logs = $obj_classs->en_freightview_sent_http_request($url, $data, 'POST');
