...
namespace EnFreightviewReceiverAddress;

/**
 * Get address from cart|checkout page.
 * Class EnFreightviewReceiverAddress
 * @package EnFreightviewReceiverAddress
 */
if (!class_exists('EnFreightviewReceiverAddress')) {
