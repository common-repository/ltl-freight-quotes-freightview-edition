...
namespace EnFreightviewSPQ;

if (!class_exists('EnFreightviewSPQ')) {

    class EnFreightviewSPQ
    {
        /**
         * Small package quotes of cart items.
         * @param array $package
        ...
        static public function en_small_package_quotes($package, $small_package)
        {
            ...
            if (!empty($small_package)) {
                $en_plugins = json_decode(get_option('EN_Plugins'), EN_FREIGHTVIEW_DECLARED_TRUE);
