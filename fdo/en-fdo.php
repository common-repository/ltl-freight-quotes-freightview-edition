...
namespace EnFreightviewFdo;

class EnFreightviewFdo
{
    ...
    static public function en_cart_package($en_package, $key)
    {
        ...
        self::$en_fdo_meta_data['plugin_name'] = 'freightview';
        $accessorials['residential'] = get_option('en_quote_settings_residential_delivery_freightview') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('en_quote_settings_liftgate_delivery_freightview') == 'yes' ? true : false;
        $accessorials['limitedaccess'] = get_option('en_quote_settings_limited_access_delivery_freightview') == 'yes' ? true : false;
